...
<head>
    ...
    <title>Login {{ config('app.name', 'Water Proofing') }}</title>
    ...
    <!-- CSS Libraries -->
    <link rel="stylesheet" href="{{ asset('core/bootstrap-social/bootstrap-social.css') }}">
        ...
        <section class="section">
            <div class="d-flex flex-wrap align-items-stretch">
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                    <div class="p-4 m-3">
                        <img src="{{ asset('core/assets/img/stisla-fill.svg') }}" alt="logo" width="80"
                            class="shadow-light rounded-circle mb-5 mt-2">
                        <h4 class="text-dark font-weight-normal">Welcome to <span class="font-weight-bold">Sainz
                                Waterproofing</span>
                        </h4>
                ...
                <div class="col-lg-8 col-12 order-lg-2 order-1 min-vh-100 background-walk-y position-relative overlay-gradient-bottom"
                    data-background="{{ asset('core/assets/img/unsplash/jakarta.jpg') }}">
                    <div class="absolute-bottom-left index-2">
                        <div class="text-light p-5 pb-2">
                            ...
                            Photo by <a class="text-light bb" target="_blank"
                                href="https://unsplash.com/photos/rF7wHTvZbwo">Eugenia Clara</a> on <a
