...
<head>
    ...
    <title>Register | {{ config('app.name', 'Booking Service System') }}</title>
                ...
                <div class="row">
                    <div
                        ...
                        <div class="login-brand">
                            <img src="{{ asset('core/assets/img/stisla-fill.svg') }}" alt="logo" width="100"
                        ...
                        <div class="simple-footer">
                            Copyright &copy; Arya Dwi Putra {{ date('Y') }}
                        </div>
                    </div>
                </div>
            </div>
